...
/*
 * image preloading with module loading
 */
const moduleFirstImage = new Image();
moduleFirstImage.src =
  "https://stillmed.olympic.org/media/Photos/2016/08/20/part-1/20-08-2016-Football-Men-01.jpg?interpolation=lanczos-none&resize=*:800";

const moduleFirstImageThumbnail = new Image();
moduleFirstImageThumbnail.src =
